...
class OrderServiceStepConfirm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      agree_terms: false,
  ...
  handleGotoStepActivationCode() {
    this.props.history.push(UrlHelper.getMainUrl('order-service/step-activation-code'));
  }
  ...
  handleSubmit() {
    this.props.history.push(UrlHelper.getMainUrl('order-service/billing'));
  }
  renderModal() {
    return (
      <Modal
      ...
      <div className={'page page--activate-sim page--panel'}>
        <div className={'section'}>
          <div className={'container'}>
            <Step steps={['Information', 'Address', 'Identity', 'Select plan', 'Confirm']} index={4} />
            {this.renderModal()}
            <div className={'row'}>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(OrderServiceStepConfirm));
