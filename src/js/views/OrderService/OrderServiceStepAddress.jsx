...
class OrderServiceStepAddress extends Component {
  constructor(props) {
    super(props);
  ...
  handleNext(event) {
    ...
    this.validator.validateAll(this.validationData).then(
      (success) => {
        if (success) {
          this.props.history.push(UrlHelper.getMainUrl('order-service/step-identity'));
        } else {
          this.setState({
            errors: this.validator.errors
          });
      ...
      <div className={'page page--activate-sim page--panel'}>
        <div className={'section'}>
          <div className={'container'}>
            <Step steps={['Information', 'Address', 'Identity', 'Select plan', 'Confirm']} index={1} />
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(OrderServiceStepAddress));
