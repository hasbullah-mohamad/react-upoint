...
class OrderServiceStepPlan extends Component {
  constructor(props) {
    super(props);
    this.state = {
      agree_terms: false
  ...
  handleNext() {
    this.props.history.push(UrlHelper.getMainUrl('order-service/step-confirm'));
  }
      ...
      <div className={'page page--activate-sim page--panel'}>
        <div className={'section'}>
          <div className={'container'}>
            <Step steps={['Information', 'Address', 'Identity', 'Select plan', 'Confirm']} index={3} />
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(OrderServiceStepPlan));
