...
const Electricity = () => (
  <div>
    ...
    <h3 className={'title-underlined-primary font-weight-extra-bold'}>uPoint Energy Info</h3>
    ...
    <h3 className={'title-underlined-primary font-weight-extra-bold'}>Signing Up</h3>
    <div className="mb-5">
    ...
    <h3 className={'title-underlined-primary font-weight-extra-bold'}>Prices and Billing</h3>
    <div className={'section-item mt-4'}>
    ...
    <h3 className={'title-underlined-primary font-weight-extra-bold'}>Tariffs and Metering</h3>
    <div className={'section-item mt-4'}>
    ...
    <h3 className={'title-underlined-primary font-weight-extra-bold'}>Solar VICTORIA</h3>
    <div className={'section-item mt-4'}>
    ...
    <h3 className={'title-underlined-primary font-weight-extra-bold'}>Solar NEW SOUTH WALES</h3>
    <div className={'section-item mt-4'}>
      <Collapsible trigger={'What feed-in tariff will I receive?'} transitionTime={100}>
