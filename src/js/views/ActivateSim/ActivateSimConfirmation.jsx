              ...
              <div className={'d-flex flex-column flex-md-row bg-primary'}>
                ...
                <div className={'col-md-6 panel-body bg-light'}>
                  ...
                  <ul className={'list-numeric'}>
                    <li>
                      Your new service will normally be active within 60 minutes, so please allow time for your new number to be activated.&nbsp;
                      Occasionally, delays do happen and can last 7-10 days, this is rare but you can find out more here.
                    </li>
                    <li>
                      Put your new SIM card into your handset, and when the service is active we will send you an email to let you know that your new service is ready to use.
                    </li>
                    <li>
                      Once you receive this email, you should turn your phone off for a few minutes and turn it back on,&nbsp;
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ActivateSimConfirmation));
