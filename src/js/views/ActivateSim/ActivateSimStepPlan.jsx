...
class ActivateSimStepPlan extends Component {
  constructor(props) {
    super(props);
    this.state = {
      agree_terms: false
  ...
  handleNext() {
    this.props.history.push(UrlHelper.getMainUrl('activate-sim/step-confirm'));
  }
      ...
      <div className={'page page--activate-sim page--panel'}>
        <div className={'section'}>
          <div className={'container'}>
            <Step steps={['Activation Code', 'Information', 'Address', 'Identity', 'Select plan', 'Confirm']} index={4} />
            <div className={'panel panel--primary'}>
              <div className={'panel-body'}>
                ...
                <p className={'text-center'}>
                  All of our plans are 12 month SIM Only. For more information, please refer to the <NavLink to={'/'}>Critical Summary Information</NavLink>.
                </p>
                <div className={'row'}>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ActivateSimStepPlan));
