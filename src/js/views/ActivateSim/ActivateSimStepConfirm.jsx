...
class ActivateSimStepConfirm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      agree_terms: false,
      ...
      <div className={'page page--activate-sim page--panel'}>
        <div className={'section'}>
          <div className={'container'}>
            <Step steps={['Activation Code', 'Information', 'Address', 'Select plan', 'Confirm']} index={4} />
            {this.renderModal()}
            <div className={'row'}>
              <div className={'col-md-6'}>
                <div className={'panel panel--primary'}>
                  ...
                  <div className={'panel-body'}>
                    <div className={'row'}>
                      <div className={'col-xs-12 col-sm-12 text-right'}>
                        ...
                        <button
                          ...
                          onClick={this.handleGotoStepActivationCode.bind(this)}>
                          Edit
                        </button>
                      </div>
                    </div>
                    <div className={'row'}>
                      <div className={'col-xs-6 col-sm-6'}>
                        <div className={'form-group text-primary'}><strong>SIM Card number</strong></div>
                      </div>
                      <div className={'col-xs-6 col-sm-6'}>
                        <div className={'form-group'}>{data.sim_card_number}</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className={'panel-stack'}>
                    ...
                    <div className={'row'}>
                      <div className={'col-xs-6 col-sm-6'}>
                        <div className={'form-group text-primary'}><strong>Account number</strong></div>
                      </div>
                      <div className={'col-xs-6 col-sm-6'}>
                        <div className={'form-group'}><strong>038308507</strong></div>
                      </div>
                    </div>
                  </div>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ActivateSimStepConfirm));
