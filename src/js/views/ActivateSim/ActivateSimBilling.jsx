...
const mapDispatchToProps = dispatch => ({
  ...
  onSubmit: data =>
    dispatch({ type: Types.ORDER_ACTIVATE, payload: services.Orders.activate(data) })
});

class ActivateSimBilling extends Component {
  constructor(props) {
    super(props);
  ...
  componentWillReceiveProps(props) {
    if (this.props.activated !== props.activated && props.activated) {
      this.props.history.push(UrlHelper.getMainUrl('activate-sim/confirmation'));
    }
  }
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ActivateSimBilling));
