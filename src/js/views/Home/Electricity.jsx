    ...
    return (
      <div className={'row mt-5 pt-4'}>
        <div className={'col-lg-5 text-center'}>
          <img className={'mb-4'} src={'img/media/oval_electricity.png'} style={{ width: '232px', height: '232px' }} alt={'oval'} />
        </div>
        <div className={'col-lg-7'}>
          <h2 className={'text-info mb-4'}>An exciting Electricity product is coming soon!</h2>
