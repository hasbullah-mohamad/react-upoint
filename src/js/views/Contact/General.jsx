      ...
      <div className={'row'}>
        <div className={'col-md-5 pr-lg-5'}>
          ...
          <p className={'font-size-base'}>
            <h5 className={'font-weight-extra-bold'}>Sales</h5>
            <a href="tel:1300156556">1300 156 556 - Option 1</a><br />
            (Monday to Thursday 9am-6pm and Friday 9am-5pm AEST)
          </p>
          <p className={'font-size-base'}>
            <h5 className={'font-weight-extra-bold'}>Accounts &amp; Billing</h5>
            <a href="tel:1300156556">1300 156 556 - Option 2</a><br />
            (Monday to Thursday 9am-6pm and Friday 9am-5pm AEST)
          </p>
