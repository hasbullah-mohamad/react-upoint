...
class PayMyBill extends Component {
  constructor(props) {
    super(props);
    console.log(props);
  }
  ...
  render() {
    return (
      <div>
        ...
        <div className="panel panel--success">
          <div className="panel-body">
            <h4 className="title-underlined-success font-weight-bold mb-4">SmoothPay</h4>
            <div>
              Avoid bill shock. Set up a recurring fortnightly or monthly payment of an amount of your choice to even out your energy bill payments. Call us to sign up.
            </div>
          </div>
        </div>
        ...
        <div className="panel panel--success">
          <div className="panel-body">
            ...
            <div>
              Use our convenient BPAY option. Contact your bank or financial institution to make this payment from your cheque, savings, debit, credit card or transaction account.
              More info at <a href="https://www.bpay.com.au" target="_blank">www.bpay.com.au</a>
              <div className="ml-5">
                <br />
                Biller code: 260364
                <br />
